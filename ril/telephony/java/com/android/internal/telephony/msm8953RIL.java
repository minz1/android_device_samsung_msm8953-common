 ...
 * {@hide}
 */
public class msm8953RIL extends RIL {

    AudioManager mAudioManager;

    public msm8953RIL(Context context, int networkMode, int cdmaSubscription) {
        this(context, networkMode, cdmaSubscription, null);
    }

    public msm8953RIL(Context context, int preferredNetworkType,
